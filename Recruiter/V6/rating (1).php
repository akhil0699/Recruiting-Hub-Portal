...
$employers=array();
$empres=mysqli_query($link,"SELECT b.name as companyname,d.memberid as employer FROM jobs a,companyprofile b ,request c, members d WHERE c.recruiterid='$mid' and c.jobid=a.jobid and a.memberid=d.memberid and b.id=d.companyid  group by b.name order by d.memberid");
...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
     <title>Rating | Recruiters Hub</title>
 ...
 <div class="col-xs-12">
      <section class="panel panel-default">
        <header class="panel-heading panel-heading--buttons wht-bg">
          <h4 class="gen-case">Feedback Rating (Rate Employer) | Go to -> <a href="psl-list"> PSL List </a></h4>
        </header>
