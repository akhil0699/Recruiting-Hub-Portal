...
$sql=mysqli_query($link,"select a.id,a.name,a.email,a.cv,a.resume,a.resume1,a.video,a.years,a.months,a.isd,a.contact,a.intype,b.designation,b.currentcompany,b.salarylakhs,b.salarythousand,b.city,a.country,a.registereddate,a.lastmodified,b.noticeperiod,b.skills,b.fromyear,b.toyear,b.frommonths,b.tomonths,c.type,c.start,c.end,c.institute,c.degree from canditate a,employment b,qualification c where a.id=b.canditateid and a.id=c.candidateid  and b.type='current' and a.id=$canditateid");
...
$sql1=mysqli_query($link,"select a.id,a.name,a.email,a.cv,a.resume,a.years,a.months,a.isd,a.contact,a.intype,b.designation,b.currentcompany,b.salarylakhs,b.salarythousand,b.city,a.country,a.registereddate,a.lastmodified,b.noticeperiod,b.skills,b.fromyear,b.toyear,b.frommonths,b.tomonths,c.type,c.start,c.end,c.institute from canditate a,employment b,qualification c where a.id=b.canditateid and a.id=c.candidateid  and b.type='previous' and a.id=$canditateid");
...
$sql2=mysqli_query($link,"select a.id,a.name,a.email,a.cv,a.resume,a.years,a.months,a.isd,a.contact,a.intype,b.designation,b.currentcompany,b.salarylakhs,b.salarythousand,b.city,a.country,a.registereddate,a.lastmodified,b.noticeperiod,b.skills,b.fromyear,b.toyear,b.frommonths,b.tomonths,c.type,c.start,c.end,c.institute from canditate a,employment b,qualification c where a.id=b.canditateid and a.id=c.candidateid  and b.type='other' and a.id=$canditateid");
...
<div class="col-lg-4 no-padding"><strong>Annual Salary/Rate:</strong></div>

<div class="col-lg-8 no-padding"><p><?php echo $profile['salarylakhs'];?> (thousands) <?php if($profile['salarythousand']) echo 'and '.$profile['salarythousand'].'thousand'; ?></p></div>
...
<div class="col-lg-4 no-padding"><strong>Education level:</strong></div>

<div class="col-lg-8 no-padding"><p><?php echo $profile['type'];?></p></div>

<div class="clearfix"></div>



<div class="col-lg-4 no-padding"><strong>College / University	:</strong></div>
...
<div class="col-lg-4 no-padding"><strong>Degree	:</strong></div>

<div class="col-lg-8 no-padding"><p><?php echo $profile['degree'];?></p></div>

<div class="clearfix"></div>



<div class="col-lg-4 no-padding"><strong>Year(from)	:</strong></div>

<div class="col-lg-8 no-padding"><p><?php echo $profile['start']; ?></p></div>
...
<div class="col-lg-4 no-padding"><strong>Year(to)	:</strong></div>

<div class="col-lg-8 no-padding"><p><?php echo $profile['end'];?></p></div>
...
<div class="col-lg-4 no-padding"><strong>coursetype	:</strong></div>
